...
import { AudienceModePicker, MediaShowcase, ResearchHub, type VisitMode } from '@/components/audience-experience';
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <ResearchHub sources={zones.map(({ index, title, source }) => ({ index, title, source }))} />
