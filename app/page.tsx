        ...
        <div id="top" className="mx-auto flex min-h-[calc(100vh-86px)] w-full max-w-[1480px] items-end px-5 pb-10 sm:px-8 sm:pb-14 lg:px-12 lg:pb-16">
          <div className="grid w-full gap-9 lg:grid-cols-[minmax(0,1fr)_430px] lg:items-end">
            ...
            <aside className="sticker-shadow rounded-[30px] border-[3px] border-[#153e4d] bg-[#fff5d5] p-5 text-[#153e4d] sm:p-6 lg:-rotate-1">
              ...
              <div className="mt-5 grid grid-cols-2 gap-3"><button onClick={() => beginJourney('waterway')} className={`path-card rounded-2xl border-2 border-[#153e4d] p-4 text-left ${path === 'waterway' ? 'bg-[#75d4ed]' : 'bg-white'} hover:bg-[#bdebf7]`}><span className="text-[10px] font-black tracking-[.15em] opacity-55">MATERIAL · 水利</span><span className="mt-7 block text-xl font-black">圳路築跡</span><span className="mt-1 block text-xs font-medium opacity-65">辨水、造水、分水</span></button><button onClick={() => beginJourney('bogong')} className={`path-card rounded-2xl border-2 border-[#153e4d] p-4 text-left ${path === 'bogong' ? 'bg-[#ff8069] text-white' : 'bg-white'} hover:bg-[#ffd3cb]`}><span className="text-[10px] font-black tracking-[.15em] opacity-55">SPIRIT · 守護</span><span className="mt-7 block text-xl font-black">伯公守水口</span><span className="mt-1 block text-xs font-medium opacity-65">守水、敬水、共水</span></button></div>
